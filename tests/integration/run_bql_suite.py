...
from simulations.sugarscape_sim.run import setup_and_run # The main simulation entry point
...
def define_behavioral_assertions() -> BQL:
    ...
    bql.assert_eventually(
        bql.PositionComponent.x > 40,
        bql.PositionComponent.y > 40
    )
...
async def main():
    ...
    reporter = BQLTestReporter(
        ...
        assertions=bql_suite.assertions
    )
