...
class UtilityNetwork(nn.Module):
    ...
    def __init__(self, state_feature_dim: int, internal_state_dim: int, action_feature_dim: int):
    ...
    def forward(
        ...
        x = torch.cat([state_features, internal_state_features, action_features], dim=-1)
